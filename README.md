...
The README serves as a **single source of truth** for understanding the project, setting it up, and contributing to its development.
...
- Support scalable and containerized deployment  
...
This README:
- Explains the purpose of the AI agent  
- Provides installation and configuration steps  
...
- **Data Sources:** API-based / Online operational data  
...
- Python 3.8+  
- Docker (optional)  
- API key for AI provider (OpenAI or Gemini)  

### 🔹 Clone the Repository
```bash
git clone https://github.com/Prasanna-0725/AI-Agent-for-Operational-Risk-and-Performance-Metrics.git
cd AI-Agent-for-Operational-Risk-and-Performance-Metrics
